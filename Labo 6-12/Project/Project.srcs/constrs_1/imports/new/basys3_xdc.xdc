...
set_property PACKAGE_PIN V17 [get_ports {compression_switch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {compression_switch}]
set_property PACKAGE_PIN V16 [get_ports {filter_switch_brightness}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {filter_switch_brightness}]
...
set_property PACKAGE_PIN U1 [get_ports {filter_switch_colourless}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {filter_switch_colourless}]
set_property PACKAGE_PIN T1 [get_ports {filter_switch_b_and_w}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {filter_switch_b_and_w}]
set_property PACKAGE_PIN R2 [get_ports {filter_switch_inverted}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {filter_switch_inverted}]